...
class ItemView : FrameLayout {
    ...
    private fun generateViews(styles: TypedArray) {
        ...
        barFilledColor = styles.getColor(R.styleable.OtpTextView_bar_filled_color,ResourcesCompat.getColor(context.resources, R.color.green, null))
...
//    }
    ...
    fun setTextColor(color: Int) {
        textView?.setTextColor(color) // Apply the color to the TextView
    }



    private fun updateViewBackground(view: View?, color: Int, resource: Int) {
...
//            }
            ...
            FILLED -> updateViewBackground(view, barFilledColor, boxBackgroundColorFilled)
